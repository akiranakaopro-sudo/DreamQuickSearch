...
public class COUIPageIndicator2 extends View implements COUIIPagerIndicator {
    ...
    public class PageIndicatorModel {
        ...
        public void setCurrentPositionInternal(int position, float offset) {
            ...
            this.mVisibleBounds[1] = this.mVisibleBounds[0] + (Math.min(MAX_VISIBLE_DOT_NUMBER, this.mIndicatorCount) * (this.mInterval + COUIPageIndicator2.this.mNormalDotSize));
        ...
        public RectF getVisibleRect() {
            this.mVisibleRect.set(0.0f, 0.0f, Math.min(MAX_VISIBLE_DOT_NUMBER, this.mIndicatorCount) * (this.mInterval + COUIPageIndicator2.this.mNormalDotSize), COUIPageIndicator2.this.mNormalDotSize);
