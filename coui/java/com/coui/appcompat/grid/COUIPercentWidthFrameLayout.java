...
public class COUIPercentWidthFrameLayout extends FrameLayout {
    ...
    private void initAttr(AttributeSet attributeSet) {
        if (getContext() != null) {
            ...
            this.mPaddingType = typedArrayObtainStyledAttributes.getInteger(R.styleable.COUIPercentWidthFrameLayout_paddingType, DEFAULT_FLAG);
            this.mPaddingSize = typedArrayObtainStyledAttributes.getInteger(R.styleable.COUIPercentWidthFrameLayout_paddingSize, LARGE_PADDING);
            ...
            this.mMode = typedArrayObtainStyledAttributes.getInt(R.styleable.COUIPercentWidthFrameLayout_percentMode, PADDING_MODE);
